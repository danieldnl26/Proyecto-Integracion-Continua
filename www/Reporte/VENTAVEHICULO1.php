...
<page  backtop="3%" backbottom="5%" backleft= "5%" backright="3%">   
    ...
    <table id="campos">
        ...
        <tbody>
            <?php
            $sqlm ="SELECT transaccion.Fecha,categoria.Nombre, vehiculo.Codigo, transaccion.idTransaccion "
                    . "FROM vehiculo INNER JOIN categoria ON vehiculo.categoria_idCategoria = categoria.idCategoria"
                    . " INNER JOIN persona ON vehiculo.persona_idPersona = persona.idPersona "
                    . "INNER JOIN transaccion ON transaccion.vehiculo_idVehiculo = vehiculo.idVehiculo "
                    . " WHERE transaccion.TipoTransaccion = 'Venta'";
